  ...
  return (
    <>
      ...
      <div className="site-content">
        ...
        <section id="attire" className="section-padding scroll-reveal">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-script text-5xl md:text-6xl text-foreground mb-4">
              {t.attire.title}
            </h2>
            <p className="text-base text-muted-foreground font-body leading-relaxed mb-2">
              {t.attire.subtitle}
            </p>
