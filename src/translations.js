const translations = {
  it: {
    ...
    photoGallery: {
      ...
      deleteModalTitle: "Elimina le tue foto",
      deleteModalPrompt: "Inserisci il tuo nome per eliminare le tue foto",
  ...
  en: {
    ...
    photoGallery: {
      ...
      photoCounter: "{current} / {total}",
      deleteButton: "Delete",
      deleteModalTitle: "Delete your photos",
      deleteModalPrompt: "Enter your name to delete your photos",
