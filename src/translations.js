const translations = {
  it: {
    ...
    photoGallery: {
      ...
      viewAllPhotos: "Visualizza tutti gli scatti",
      ...
      errors: {
        ...
        fileTooBig: "Uno o più file sono troppo grandi (foto max 10 MB, video max 50 MB)",
        videoTooLong: "Il video è troppo lungo (massimo 5 minuti)",
  ...
  en: {
    ...
    photoGallery: {
      ...
      errors: {
        ...
        fileTooBig: "One or more files are too large (photos max 10 MB, videos max 50 MB)",
        videoTooLong: "The video is too long (maximum 5 minutes)",
